...
2. Alertas automáticas de SKUs en riesgo de quiebre a 15 días, priorizadas por urgencia.
3. Sugerencia de orden (cantidad + fecha) calculando lead time de proveedor.
...
| 6 planeadores adicionales | Alimentos (2), Hogar (2), Personal (1) | Usuarios finales del dashboard | Tiempo normal |
...
| Excel de promociones comerciales | Promociones de canal moderno contratadas | [PENDIENTE: verificar estructura del archivo antes del inicio — si columnas son inconsistentes entre analistas o cambian frecuentemente, se pospone a v2 y en v1 se modelan solo las temporadas conocidas como variables calendario.] |
...
Seis semanas de operación en paralelo: los planeadores mantienen su proceso actual y simultáneamente utilizan las recomendaciones del modelo, registrando cuándo coinciden y cuándo difieren. El piloto inicia en la **última semana de agosto de 2026** y concluye en la primera semana de octubre, justo antes del cierre del presupuesto de compras Q4.
...
### Zonas grises y umbrales de decisión (fill rate diciembre 2026)

| Resultado | Decisión |
|-----------|----------|
| ≥ 91% | Éxito. Proyecto continúa a fase 2 sin cuestionamiento. |
| ≥ 89% y < 91% | Zona gris — continúa sin cuestionamiento. |
| ≥ 87% y < 89% | Zona gris — revisión de causas antes de decidir continuidad. |
| < 87% | Fracaso del proyecto. |

### Autoridad para declarar producción

SPONSOR con aval explícito de Laura Gómez. Gerente de Compras: informado, sin veto. CEO: solo si se excede el presupuesto o el alcance cambia significativamente durante la prueba.
...
2. Después de 2-3 semanas del piloto, el equipo siente que hace más trabajo del anterior sin mejora perceptible.
...
**1 de septiembre de 2026** — el modelo debe estar en producción en esa fecha. Justificación: los planeadores necesitan mínimo 3 meses de uso para que las órdenes influenciadas por el modelo impacten el inventario disponible en diciembre 2026. Adicionalmente, el cierre del presupuesto de compras Q4 ocurre en la primera semana de octubre — si el modelo no está operando antes, ese ciclo se pierde completamente.
...
- **Riesgo de continuidad — Roberto Sánchez:** tiene conversaciones internas sobre una posible promoción a coordinador regional que lo sacaría del equipo de planeación antes de octubre 2026. Probabilidad estimada baja, pero no nula. Si ocurre, se pierde al usuario más influyente durante el cierre del piloto.
  - [PENDIENTE: definir plan de contingencia ante salida de Roberto Sánchez antes de octubre 2026; responsable: SPONSOR, antes del kick-off.]
...
| Excel de promociones de canal moderno | [PENDIENTE: si estructura del Excel es consistente, carga semanal manual por Carlos; si es inconsistente, se pospone a v2 y se modela con variables calendario únicamente.] |
...
**[PENDIENTE: confirmar compatibilidad móvil de Power Apps para este caso de uso — requisito no negociable de Laura: el override debe registrarse desde cualquier dispositivo (celular, sala de reuniones) en el momento de la decisión, no en desktop horas después. Validación técnica: Carlos, semana 1 del proyecto.]**
